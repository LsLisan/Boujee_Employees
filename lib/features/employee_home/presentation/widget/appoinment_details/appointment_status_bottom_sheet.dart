...
class AppointmentStatusBottomSheet extends StatelessWidget {
  const AppointmentStatusBottomSheet({super.key});
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFFC78330), // Golden brown theme color
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Steps List
                          ...List.generate(details.progressSteps.length, (index) {
                            final step = details.progressSteps[index];
                            final isLast = index == details.progressSteps.length - 1;
            ...
            children: [
              CustomText(
                ...
                color: isCurrent
                    ...
                    : (isCompleted ? const Color(0xFF4CAF50) : Colors.grey.shade500),
              ),
